...
import { MercadoPublicoProcessDetailSidePanelPage } from '@/mercado-publico/components/MercadoPublicoProcessDetailSidePanelPage';
...
export const SIDE_PANEL_PAGES_CONFIG = new Map<SidePanelPages, React.ReactNode>(
  [
    ...
    [
      ...
      <MercadoPublicoProcessDetailSidePanelPage />,
    ],
  ],
);
