...
- The task is about skill behavior boundaries inside this package rather than root `.agents` tooling or general repo docs.
...
- The prompt is about root `.agents` routing or broader AI-tooling surfaces rather than this package specifically.
...
- Preserve the distinction between this package's Claude skills and the separate `.agents` or plugin tooling surfaces.
