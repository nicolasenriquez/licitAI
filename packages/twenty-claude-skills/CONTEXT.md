...
- This is a package-scoped skill surface, not the root `.agents` workflow surface and not the `twenty-codex-plugin` surface.
...
- root `.agents` routing or local workflow configuration
