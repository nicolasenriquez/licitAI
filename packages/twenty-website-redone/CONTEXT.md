---
type: context
title: "Twenty Website Redone Context"
description: "Context and scope guide for Twenty Website Redone."
okf_version: "0.1"
---
# Twenty Website Redone Context

## Purpose

Describe the role of `packages/twenty-website-redone` during the workspace routing rollout.

## What Lives Here

- The redesigned Twenty marketing website.
- Website pages, components, styles, and public-facing content.
- Website build configuration, routing, and deployment metadata.

## Current Routing Status

- `packages/twenty-website-redone` is mapped as a remaining-package leaf surface (wave 5).
- The `packages/` index surface must be consulted before entering this surface.

## How To Use This Surface

Use `packages/twenty-website-redone` for redesigned website work such as:

- adding or modifying website pages and components
- adjusting website styles, content, or copy
- working on website build config or deployment
