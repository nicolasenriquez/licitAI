...
import { MpV2RetryScopeHardeningFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-16/2-16-instance-command-fast-1795000000000-mp-v2-retry-scope-hardening';
...
export const INSTANCE_COMMANDS = [
  ...
  MpV2DetailContractFastInstanceCommand,
  MpV2SyncOperationsPreflightFastInstanceCommand,
  MpV2SyncOperationsFastInstanceCommand,
  ...
  MpV2RetryScopeHardeningFastInstanceCommand,
