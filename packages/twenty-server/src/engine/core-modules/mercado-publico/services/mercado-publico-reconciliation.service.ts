      ...
      `
        WITH canonical AS (
          SELECT
            ...
            buyer_code,
            buyer_name,
            NULL::text AS buyer_rut,
            NULL::text AS purchase_unit_name,
            NULL::text AS region_name,
            NULL::numeric AS amount_available_clp,
            NULL::text AS call_stage,
            NULL::integer AS document_count,
            NULL::integer AS offers_received_count,
        ...
        SET title = EXCLUDED.title,
            ...
            amount_available_clp = EXCLUDED.amount_available_clp,
