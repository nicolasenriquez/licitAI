...
Read `.codex/commands/README.md`, `.codex/commands/prime.md`,
`.codex/commands/execute.md`, `AGENTS.md`, or relevant `opsx-*.md` files only
when they are needed to resolve command compatibility or repo-local workflow
expectations.
