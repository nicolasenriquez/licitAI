...
3. `AGENTS.md`
4. `CONTEXT.md`
5. The specific command `SKILL.md` or skill `SKILL.md` relevant to the task
...
When that happens, return to `../CONTEXT-MAP.md` first and reroute from there. Do not keep working from `.codex`.
