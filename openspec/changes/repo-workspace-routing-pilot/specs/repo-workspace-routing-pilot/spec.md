...
- **THEN** the root contract is defined by `AGENTS.md`, `CLAUDE.md`, and `CONTEXT-MAP.md`
...
- **THEN** the agent returns to `CONTEXT-MAP.md`
...
- **AND** `CONTEXT-MAP.md` is updated to describe that surface
