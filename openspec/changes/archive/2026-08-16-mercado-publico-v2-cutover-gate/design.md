...
5. End live legacy rollback when G5 starts.
   ...
   The G4 gate-close record supplies one immutable approved rollback reference
   for G5 rollback instead. The 2026-08-16 operator decision in `proposal.md`
   `## Gate Status` records gate-close commit `49d115e768` and supersedes the
